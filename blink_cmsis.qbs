...
import qbs
import "qbs/stm32f1.qbs" as stm32f1
...
Project {
     ...
     * - STM32F107xC
     */
    readonly property string microcontroller_series: "STM32F103xB"
    ...
    stm32f1 {
        ...
        property string halPath       : basePath + "/Drivers/STM32F1xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32F1xx/Include")
            }
            ...
            if (project.freertos) {
                ...
                if (project.mpu) {
                    includePaths.push(freertosPath + "/Source/portable/GCC/ARM_CM3_MPU")
                } else {
                    includePaths.push(freertosPath + "/Source/portable/GCC/ARM_CM3")
                }
            }
        ...
        cpp.staticLibraries: {
            ...
            if (project.cmsis_math) {
                staticLibraries.push("arm_cortexM3l_math")
            }

            if (project.audio) {
                staticLibraries.push("PDMFilter_CM3_GCC")
            }

            if (project.stemwin) {
                if (project.freertos) {
                    staticLibraries.push("STemWin" + project.stemwin_v + "_CM3_OS_GCC")
                } else {
                    staticLibraries.push("STemWin" + project.stemwin_v + "_CM3_GCC")
                }
            }
